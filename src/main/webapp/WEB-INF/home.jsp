...
<div class="input-group" style="width: 250px;margin-left: 50px;margin-top: 10px;">
    ...
    <button type="button" id="btntrans">번역하기</button>

    <i class="bi bi-megaphone speak voicespeak" style="font-size: 1.8em;margin-left: 10px;cursor: pointer;"></i>
</div>
<div id="trans" style="margin-top: 20px;width: 100%;font-size: 20px;"></div>
